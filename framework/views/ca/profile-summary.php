...
<table class="yiiLog" width="100%" cellpadding="2"
	...
	<tr>
		<th style="background: black; color: white;" colspan="6">Reportatge
		Perfilat Resumit (Profiling Summary Report) (Temps: <?php echo sprintf('%0.5f',Yii::getLogger()->getExecutionTime()); ?>s,
