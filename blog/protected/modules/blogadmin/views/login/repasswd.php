...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tbody><tr>
    <td background="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/images/admin_m/mail_leftbg.gif" height="29" valign="top" width="17"><img src="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/images/admin_m/left-top-right.gif" height="29" width="17"></td>
    <td background="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/images/admin_m/content-bg.gif" height="29" valign="top"><table class="left_topbg" id="table2" border="0" cellpadding="0" cellspacing="0" height="31" width="100%">
      <tbody><tr>
  ...
  <tr>
    <td background="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/images/admin_m/mail_leftbg.gif" height="71" valign="middle">&nbsp;</td>
        ...
        <td valign="top"><table align="center" border="0" cellpadding="0" cellspacing="0" width="98%">
          ...
          <tr>
            <td><table border="0" cellpadding="0" cellspacing="0" height="55" width="100%">
              <tbody><tr>
                <td height="55" valign="middle" width="10%"><img src="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/images/admin_m/title.gif" height="55" width="54"></td>
  ...
  <tr>
    <td background="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/images/admin_m/mail_leftbg.gif" valign="middle"><img src="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/images/admin_m/buttom_left2.gif" height="17" width="17"></td>
      <td background="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/images/admin_m/buttom_bgs.gif" height="17" valign="top"><img src="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/images/admin_m/buttom_bgs.gif" height="17" width="17"></td>
    <td background="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/images/admin_m/mail_rightbg.gif"><img src="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/images/admin_m/buttom_right2.gif" height="17" width="16"></td>
  </tr>
</tbody></table>
